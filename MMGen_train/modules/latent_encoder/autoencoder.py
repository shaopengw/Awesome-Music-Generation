...
import numpy as np
from MMGen_train.modules.diffusionmodules.ema import *

from torch.optim.lr_scheduler import LambdaLR
from MMGen_train.modules.diffusionmodules.model import Encoder, Decoder
...
from MMGen_train.utilities.model_util import get_vocoder
from MMGen_train.utilities.tools import synth_one_sample
import itertools
...
class AutoencoderKL(pl.LightningModule):
    ...
    def decode_to_waveform(self, dec):
        from MMGen_train.utilities.model_util import vocoder_infer
